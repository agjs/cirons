...
(function() {
  ...
  function dashboardController($scope, $filter, dashboardFactory) {
    ...
    dashboardFactory.getDashboardData().then(function(data) {
      ...
      $scope.expenses_bar_current = {};
      $scope.expenses_bar_current.variable = data.expenses_bar_current.supp;
      $scope.expenses_bar_current.fixed = data.expenses_bar_current.fixed;
      $scope.expenses_bar_current.receipts = data.expenses_bar_current.rec;
      $scope.expenses_bar_current.sales = data.expenses_bar_current.sales;
